...
class adc_4x16g_asnt(YellowBlock):
    ...
    def gen_constraints(self):
        ...
        cons.append(RawConstraint('set_false_path -from [get_clocks -of_objects [get_pins {adc4x16g_adc4x16g_inst0/adc4x16g_core_0/inst/GTY_quad0/inst/gen_gtwizard_gtye4_top.gtwizard_ultrascale_0_gtwizard_gtye4_inst/gen_gtwizard_gtye4.gen_channel_container[2].gen_enabled_channel.gtye4_channel_wrapper_inst/channel_inst/gtye4_channel_gen.gen_gtye4_channel_inst[3].GTYE4_CHANNEL_PRIM_INST/RXOUTCLK}]] -to [get_clocks -of_objects [get_pins adc4x16g_adc4x16g_inst0/adc4x16g_core_0/inst/BUFG_GT_inst/O]]'))
        cons.append(RawConstraint('set_false_path -from [get_clocks -of_objects [get_pins {adc4x16g_adc4x16g_inst1/adc4x16g_core_0/inst/GTY_quad0/inst/gen_gtwizard_gtye4_top.gtwizard_ultrascale_0_gtwizard_gtye4_inst/gen_gtwizard_gtye4.gen_channel_container[2].gen_enabled_channel.gtye4_channel_wrapper_inst/channel_inst/gtye4_channel_gen.gen_gtye4_channel_inst[3].GTYE4_CHANNEL_PRIM_INST/RXOUTCLK}]] -to [get_clocks -of_objects [get_pins adc4x16g_adc4x16g_inst0/adc4x16g_core_0/inst/BUFG_GT_inst/O]]'))
